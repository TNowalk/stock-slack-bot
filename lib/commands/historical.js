  ...
  help(bot) {
    return new Promise((resolve) => {
      resolve(
        ...
        'If no arguments are provided, the default length of ' +
        `time is the last ${this.DEFAULT_TIMEFRAME} days.\n` +
        `To run command, type: \`@${bot.name} ${this.aliases[0]} $AAPL 30 days\`\n`
      );
    });
  }
